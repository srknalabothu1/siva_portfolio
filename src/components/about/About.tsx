...
const About = () => {
    const onResumeOpen = () => {
        window.open(`${process.env.NEXT_PUBLIC_API_URL}/pdf/Sivaramakrishna_Resume.pdf`, "_blank");
    }
    return (
            ...
            <div className="w-full md:w-auto max-w-sm rounded overflow-hidden shadow-lg bg-white text-black m-4">
                ...
                <div className="px-6 py-4">
                    <div className="text-base">
                        <b>Suresh Mungara</b><br />
                        <div className='text-gray-400 text-sm'>Data Engineer |<br /> DataStage,Unix,Sql |<br /> MERN Stack | ReactNative</div>
                    </div>
                </div>
            </div>
            <div className="m-4 text-center md:text-left">
                <h1 className='text-2xl'><b>Hello there!! 👋 </b></h1> <br />
                <h2 className='text-xl'>I'm Suresh Mungara, nice to meet you. Please take a look around!</h2><br />
                <h5 className='text-base'>I am dedicated to creating exceptional software that enhances the lives of users. My expertise lies in developing applications tailored to the specific needs of businesses. With over six years of experience in software development, mobile app creation, and front-end/back-end web development, I am proficient in database and server management. I have a strong passion for JavaScript, Node.js, React, Redux, ReactNative, HTML, CSS,tailwind and Bootstrap.</h5>
